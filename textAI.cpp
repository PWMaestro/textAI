...
int main()
{
    ...
    string text = "¬сем привет, как ваши дела, и как вы себ€ чувствуете?) „ем вы занимаетесь? ƒавайте сходим куда-нибудь погул€ть. ¬сем привет, как ваши дела, и как вы себ€ чувствуете?) „ем вы занимаетесь? ƒавайте сходим куда-нибудь погул€ть.";
